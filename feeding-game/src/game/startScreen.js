function StartScreen() {
  ...
  function create() {
    ...
    text1 = game.add.text(game.world.centerX, 64, '', {font: '16px PressStart2P', fill: '#FFFFFF'});
    ...
    text2 = game.add.text(game.world.centerX, 152, '', {font: '16px PressStart2P', fill: '#FFFFFF'});
